...
// tests for SubscriptionTraceNotificationDeliveryLog
void main() {
  var instance = SubscriptionTraceNotificationDeliveryLog();

  group('test SubscriptionTraceNotificationDeliveryLog', () {
