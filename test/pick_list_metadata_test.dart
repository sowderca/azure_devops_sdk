...
// tests for PickListMetadata
void main() {
  var instance = PickListMetadata();

  group('test PickListMetadata', () {
    // ID of the picklist
    ...
    // bool isSuggested (default value: null)
    test('to test the property `isSuggested`', () async {
      // TODO
    });
