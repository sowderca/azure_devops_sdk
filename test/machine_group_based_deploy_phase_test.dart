...
// tests for MachineGroupBasedDeployPhase
void main() {
  var instance = MachineGroupBasedDeployPhase();

  group('test MachineGroupBasedDeployPhase', () {
    ...
    // List<WorkflowTask> workflowTasks (default value: [])
    test('to test the property `workflowTasks`', () async {
      // TODO
    });
