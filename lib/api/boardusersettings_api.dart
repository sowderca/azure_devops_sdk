...
class BoardusersettingsApi {
  ...
  BoardusersettingsApi([ApiClient apiClient]) : apiClient = apiClient ?? defaultApiClient;
  ...
  Future<BoardUserSettings> callGet(String organization, String project, String board, String team, String apiVersion) async {
    ...
    String path = "/{organization}/{project}/{team}/_apis/work/boards/{board}/boardusersettings".replaceAll("{format}","json").replaceAll("{" + "organization" + "}", organization.toString()).replaceAll("{" + "project" + "}", project.toString()).replaceAll("{" + "board" + "}", board.toString()).replaceAll("{" + "team" + "}", team.toString());
    ...
    if(response.statusCode >= 400) {
      ...
      return apiClient.deserialize(_decodeBodyBytes(response), 'BoardUserSettings') as BoardUserSettings;
    } else {
      return null;
    }
  }
