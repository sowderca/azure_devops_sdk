...
class PullRequestCommentLikesApi {
  final ApiClient apiClient;

  PullRequestCommentLikesApi([ApiClient apiClient]) : apiClient = apiClient ?? defaultApiClient;
  ...
  Future create(String organization, String repositoryId, int pullRequestId, int threadId, int commentId, String project, String apiVersion) async {
    ...
    String path = "/{organization}/{project}/_apis/git/repositories/{repositoryId}/pullRequests/{pullRequestId}/threads/{threadId}/comments/{commentId}/likes".replaceAll("{format}","json").replaceAll("{" + "organization" + "}", organization.toString()).replaceAll("{" + "repositoryId" + "}", repositoryId.toString()).replaceAll("{" + "pullRequestId" + "}", pullRequestId.toString()).replaceAll("{" + "threadId" + "}", threadId.toString()).replaceAll("{" + "commentId" + "}", commentId.toString()).replaceAll("{" + "project" + "}", project.toString());
