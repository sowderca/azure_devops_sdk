...
class CommentsApi {
  ...
  Future<Comment> add(String organization, String project, int workItemId, String apiVersion, CommentCreate body) async {
    ...
    String path = "/{organization}/{project}/_apis/wit/workItems/{workItemId}/comments".replaceAll("{format}","json").replaceAll("{" + "organization" + "}", organization.toString()).replaceAll("{" + "project" + "}", project.toString()).replaceAll("{" + "workItemId" + "}", workItemId.toString());
  ...
  Future delete(String organization, String project, int workItemId, int commentId, String apiVersion) async {
    ...
    // create path and map variables
    String path = "/{organization}/{project}/_apis/wit/workItems/{workItemId}/comments/{commentId}".replaceAll("{format}","json").replaceAll("{" + "organization" + "}", organization.toString()).replaceAll("{" + "project" + "}", project.toString()).replaceAll("{" + "workItemId" + "}", workItemId.toString()).replaceAll("{" + "commentId" + "}", commentId.toString());
  ...
  Future<CommentList> get Comments Batch(String organization, String project, int workItemId, String ids, String apiVersion, { bool includeDeleted, String $expand }) async {
    ...
    if(response.statusCode >= 400) {
      ...
      return apiClient.deserialize(_decodeBodyBytes(response), 'CommentList') as CommentList;
    } else {
      return null;
    }
  }
