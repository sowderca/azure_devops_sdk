...
class DestinationTestPlanCloneParams {
  ...
  @override
  String toString() {
    return 'DestinationTestPlanCloneParams[areaPath=$areaPath, buildDefinition=$buildDefinition, buildId=$buildId, description=$description, endDate=$endDate, iteration=$iteration, name=$name, owner=$owner, releaseEnvironmentDefinition=$releaseEnvironmentDefinition, startDate=$startDate, state=$state, testOutcomeSettings=$testOutcomeSettings, ]';
  }

  DestinationTestPlanCloneParams.fromJson(Map<String, dynamic> json) {
    if (json == null) return;
  ...
  static List<DestinationTestPlanCloneParams> listFromJson(List<dynamic> json) {
    return json == null ? List<DestinationTestPlanCloneParams>() : json.map((value) => DestinationTestPlanCloneParams.fromJson(value)).toList();
  }

  static Map<String, DestinationTestPlanCloneParams> mapFromJson(Map<String, dynamic> json) {
    var map = Map<String, DestinationTestPlanCloneParams>();
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic value) => map[key] = DestinationTestPlanCloneParams.fromJson(value));
    }
    return map;
  }
}
