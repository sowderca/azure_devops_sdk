...
class BuildArtifactDownloadInput {
  ...
  @override
  String toString() {
    return 'BuildArtifactDownloadInput[alias=$alias, artifactDownloadMode=$artifactDownloadMode, artifactItems=$artifactItems, artifactType=$artifactType, ]';
  }

  BuildArtifactDownloadInput.fromJson(Map<String, dynamic> json) {
    if (json == null) return;
    if (json['alias'] == null) {
      alias = null;
    } else {
  ...
  static List<BuildArtifactDownloadInput> listFromJson(List<dynamic> json) {
    return json == null ? List<BuildArtifactDownloadInput>() : json.map((value) => BuildArtifactDownloadInput.fromJson(value)).toList();
  }

  static Map<String, BuildArtifactDownloadInput> mapFromJson(Map<String, dynamic> json) {
    var map = Map<String, BuildArtifactDownloadInput>();
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic value) => map[key] = BuildArtifactDownloadInput.fromJson(value));
    }
    return map;
  }
}
