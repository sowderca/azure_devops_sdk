...
class IdentityBase {
  ...
  static List<IdentityBase> listFromJson(List<dynamic> json) {
    return json == null ? List<IdentityBase>() : json.map((value) => IdentityBase.fromJson(value)).toList();
  }

  static Map<String, IdentityBase> mapFromJson(Map<String, dynamic> json) {
    var map = Map<String, IdentityBase>();
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic value) => map[key] = IdentityBase.fromJson(value));
    }
    return map;
  }
}
