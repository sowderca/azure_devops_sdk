...
class TestDefinition {
  ...
  @override
  String toString() {
    return 'TestDefinition[accessData=$accessData, createdBy=$createdBy, createdDate=$createdDate, id=$id, lastModifiedBy=$lastModifiedBy, lastModifiedDate=$lastModifiedDate, loadTestType=$loadTestType, name=$name, ]';
  }

  TestDefinition.fromJson(Map<String, dynamic> json) {
    if (json == null) return;
  ...
  static List<TestDefinition> listFromJson(List<dynamic> json) {
    return json == null ? List<TestDefinition>() : json.map((value) => TestDefinition.fromJson(value)).toList();
  }

  static Map<String, TestDefinition> mapFromJson(Map<String, dynamic> json) {
    var map = Map<String, TestDefinition>();
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic value) => map[key] = TestDefinition.fromJson(value));
    }
    return map;
  }
}
