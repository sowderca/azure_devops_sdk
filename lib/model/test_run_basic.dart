...
class TestRunBasic {
  ...
  static List<TestRunBasic> listFromJson(List<dynamic> json) {
    return json == null ? List<TestRunBasic>() : json.map((value) => TestRunBasic.fromJson(value)).toList();
  }

  static Map<String, TestRunBasic> mapFromJson(Map<String, dynamic> json) {
    var map = Map<String, TestRunBasic>();
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic value) => map[key] = TestRunBasic.fromJson(value));
    }
    return map;
  }
}
