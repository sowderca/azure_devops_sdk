...
class CustomArtifactDownloadInput {
  ...
  @override
  String toString() {
    return 'CustomArtifactDownloadInput[alias=$alias, artifactDownloadMode=$artifactDownloadMode, artifactItems=$artifactItems, artifactType=$artifactType, ]';
  }

  CustomArtifactDownloadInput.fromJson(Map<String, dynamic> json) {
    if (json == null) return;
    if (json['alias'] == null) {
      alias = null;
    } else {
  ...
  static List<CustomArtifactDownloadInput> listFromJson(List<dynamic> json) {
    return json == null ? List<CustomArtifactDownloadInput>() : json.map((value) => CustomArtifactDownloadInput.fromJson(value)).toList();
  }

  static Map<String, CustomArtifactDownloadInput> mapFromJson(Map<String, dynamic> json) {
    var map = Map<String, CustomArtifactDownloadInput>();
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic value) => map[key] = CustomArtifactDownloadInput.fromJson(value));
    }
    return map;
  }
}
