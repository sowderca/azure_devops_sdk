...
class Widget {
  ...
  static List<Widget> listFromJson(List<dynamic> json) {
    return json == null ? List<Widget>() : json.map((value) => Widget.fromJson(value)).toList();
  }

  static Map<String, Widget> mapFromJson(Map<String, dynamic> json) {
    var map = Map<String, Widget>();
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic value) => map[key] = Widget.fromJson(value));
    }
    return map;
  }
}
