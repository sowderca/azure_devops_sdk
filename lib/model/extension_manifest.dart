...
class ExtensionManifest {
  ...
  static List<ExtensionManifest> listFromJson(List<dynamic> json) {
    return json == null ? List<ExtensionManifest>() : json.map((value) => ExtensionManifest.fromJson(value)).toList();
  }

  static Map<String, ExtensionManifest> mapFromJson(Map<String, dynamic> json) {
    var map = Map<String, ExtensionManifest>();
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic value) => map[key] = ExtensionManifest.fromJson(value));
    }
    return map;
  }
}
