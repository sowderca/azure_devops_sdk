...
class KubernetesResource {
  ...
  @override
  String toString() {
    return 'KubernetesResource[createdBy=$createdBy, createdOn=$createdOn, environmentReference=$environmentReference, id=$id, lastModifiedBy=$lastModifiedBy, lastModifiedOn=$lastModifiedOn, name=$name, type=$type, ]';
  }

  KubernetesResource.fromJson(Map<String, dynamic> json) {
    if (json == null) return;
  ...
  static List<KubernetesResource> listFromJson(List<dynamic> json) {
    return json == null ? List<KubernetesResource>() : json.map((value) => KubernetesResource.fromJson(value)).toList();
  }

  static Map<String, KubernetesResource> mapFromJson(Map<String, dynamic> json) {
    var map = Map<String, KubernetesResource>();
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic value) => map[key] = KubernetesResource.fromJson(value));
    }
    return map;
  }
}
