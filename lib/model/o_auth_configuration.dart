...
class OAuthConfiguration {
  ...
  @override
  String toString() {
    return 'OAuthConfiguration[clientId=$clientId, clientSecret=$clientSecret, createdBy=$createdBy, createdOn=$createdOn, endpointType=$endpointType, id=$id, modifiedBy=$modifiedBy, modifiedOn=$modifiedOn, name=$name, url=$url, ]';
  }

  OAuthConfiguration.fromJson(Map<String, dynamic> json) {
    if (json == null) return;
  ...
  static List<OAuthConfiguration> listFromJson(List<dynamic> json) {
    return json == null ? List<OAuthConfiguration>() : json.map((value) => OAuthConfiguration.fromJson(value)).toList();
  }

  static Map<String, OAuthConfiguration> mapFromJson(Map<String, dynamic> json) {
    var map = Map<String, OAuthConfiguration>();
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic value) => map[key] = OAuthConfiguration.fromJson(value));
    }
    return map;
  }
}
