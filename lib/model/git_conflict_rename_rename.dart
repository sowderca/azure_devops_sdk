...
class GitConflictRenameRename {
  ...
  static List<GitConflictRenameRename> listFromJson(List<dynamic> json) {
    return json == null ? List<GitConflictRenameRename>() : json.map((value) => GitConflictRenameRename.fromJson(value)).toList();
  }

  static Map<String, GitConflictRenameRename> mapFromJson(Map<String, dynamic> json) {
    var map = Map<String, GitConflictRenameRename>();
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic value) => map[key] = GitConflictRenameRename.fromJson(value));
    }
    return map;
  }
}
