...
class TaskDefinition {
  ...
  static List<TaskDefinition> listFromJson(List<dynamic> json) {
    return json == null ? List<TaskDefinition>() : json.map((value) => TaskDefinition.fromJson(value)).toList();
  }

  static Map<String, TaskDefinition> mapFromJson(Map<String, dynamic> json) {
    var map = Map<String, TaskDefinition>();
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic value) => map[key] = TaskDefinition.fromJson(value));
    }
    return map;
  }
}
