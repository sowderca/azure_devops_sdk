...
class AccountRecentActivityWorkItemModel2 {
  ...
  @override
  String toString() {
    return 'AccountRecentActivityWorkItemModel2[activityDate=$activityDate, activityType=$activityType, changedDate=$changedDate, id=$id, identityId=$identityId, state=$state, teamProject=$teamProject, title=$title, workItemType=$workItemType, ]';
  }

  AccountRecentActivityWorkItemModel2.fromJson(Map<String, dynamic> json) {
    if (json == null) return;
  ...
  static List<AccountRecentActivityWorkItemModel2> listFromJson(List<dynamic> json) {
    return json == null ? List<AccountRecentActivityWorkItemModel2>() : json.map((value) => AccountRecentActivityWorkItemModel2.fromJson(value)).toList();
  }

  static Map<String, AccountRecentActivityWorkItemModel2> mapFromJson(Map<String, dynamic> json) {
    var map = Map<String, AccountRecentActivityWorkItemModel2>();
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic value) => map[key] = AccountRecentActivityWorkItemModel2.fromJson(value));
    }
    return map;
  }
}
