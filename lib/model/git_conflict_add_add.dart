...
class GitConflictAddAdd {
  ...
  static List<GitConflictAddAdd> listFromJson(List<dynamic> json) {
    return json == null ? List<GitConflictAddAdd>() : json.map((value) => GitConflictAddAdd.fromJson(value)).toList();
  }

  static Map<String, GitConflictAddAdd> mapFromJson(Map<String, dynamic> json) {
    var map = Map<String, GitConflictAddAdd>();
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic value) => map[key] = GitConflictAddAdd.fromJson(value));
    }
    return map;
  }
}
