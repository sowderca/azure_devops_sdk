...
class GitConflictFileDirectory {
  ...
  static List<GitConflictFileDirectory> listFromJson(List<dynamic> json) {
    return json == null ? List<GitConflictFileDirectory>() : json.map((value) => GitConflictFileDirectory.fromJson(value)).toList();
  }

  static Map<String, GitConflictFileDirectory> mapFromJson(Map<String, dynamic> json) {
    var map = Map<String, GitConflictFileDirectory>();
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic value) => map[key] = GitConflictFileDirectory.fromJson(value));
    }
    return map;
  }
}
