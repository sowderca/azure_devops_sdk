...
class DeploymentInput {
  ...
  @override
  String toString() {
    return 'DeploymentInput[condition=$condition, jobCancelTimeoutInMinutes=$jobCancelTimeoutInMinutes, overrideInputs=$overrideInputs, timeoutInMinutes=$timeoutInMinutes, ]';
  }

  DeploymentInput.fromJson(Map<String, dynamic> json) {
    if (json == null) return;
  ...
  static List<DeploymentInput> listFromJson(List<dynamic> json) {
    return json == null ? List<DeploymentInput>() : json.map((value) => DeploymentInput.fromJson(value)).toList();
  }

  static Map<String, DeploymentInput> mapFromJson(Map<String, dynamic> json) {
    var map = Map<String, DeploymentInput>();
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic value) => map[key] = DeploymentInput.fromJson(value));
    }
    return map;
  }
}
