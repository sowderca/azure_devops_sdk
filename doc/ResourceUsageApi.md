# azure_devops_sdk.api.ResourceUsageApi
...
------------- | ------------- | -------------
[**callGet**](ResourceUsageApi.md#callGet) | **GET** /{organization}/_apis/build/resourceusage | 


# **callGet**
> BuildResourceUsage callGet(organization, apiVersion)
...
var api_instance = ResourceUsageApi();
...
try { 
    ...
    print("Exception when calling ResourceUsageApi->callGet: $e\n");
}
```
